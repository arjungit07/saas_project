...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: "AI Analyis",
    description:
      "Our advanced AI processed and analyzes your document instantly",
  },
  {
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.4%, 45.2% 34.5%, 27.5%, 76.7%, 0.1%, 64.9%, 17.9%, 100% ,27.6%, 76.8%, 76.14, 97.7%, 74.1%,44.1%)",
            }}
          />
        </div>
  ...
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl from-rose-500/10 to-transparent group-hover:from-rose-500/20 transition-colors">
