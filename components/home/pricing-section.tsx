...
const plans = [
  {
    name: "Basic",
    price: 9,
    description: "Perfect for occasion use",
    items: [
  ...
  },
  {
    ...
    items: ["Unlimited PDF summaries", "Priority Processing", "24/7 Support"],
    id: "pro",
    paymentlink: "",
    priceId: "",
  },
      ...
      >
        <div className="relative flex justify-between items-center gap-4">
          <div>
            ...
            <p className="text-base-content/8- mt-2">description</p>
          </div>
        </div>
        ...
        <div className="space-y-2 flex justify-center w-full">
          <Link
            href={paymentlink}
            className={cn(
              "w-full rounded-full flex items-center justify-center gap-2 bg-gradient-to-r from-rose-800 to-rose-500 hover:to-rose-800 text-white border-2 py-2",
              id === "pro"
                ? "border-rose-900"
